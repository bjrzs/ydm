...
export const isUpdatable = () => {
  ...
  const resFile = fs.existsSync(path.join(process.resourcesPath, 'app-update.yml'))
  if (!resFile) {
    ...
    return true
  } else if (process.platform === 'win32' && fs.existsSync(path.join(process.resourcesPath, 'md.ico'))) {
